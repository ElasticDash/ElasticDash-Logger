...
<div align="center">
  <div>
    <h3>
    <a href="https://elasticdash.com/cn">
        <strong>🇨🇳 🤝 🪢</strong>
      </a> · 
  ...
  <div>
    <a href="https://elasticdash.com/docs"><strong>文档</strong></a> ·
    <a href="https://elasticdash.com/issues"><strong>报告问题</strong></a> ·
    <a href="https://elasticdash.com/ideas"><strong>功能请求</strong></a> ·
    <a href="https://elasticdash.com/changelog"><strong>更新日志</strong></a> ·
    <a href="https://elasticdash.com/roadmap"><strong>路线图</strong></a> ·
  </div>
  <br/>
  <span>ElasticDash 使用 <a href="https://github.com/orgs/elasticdash/discussions"><strong>GitHub Discussions</strong></a> 作为支持和功能请求的平台。</span>
  <br/>
  <span><b>我们正在招聘。</b> <a href="https://elasticdash.com/careers"><strong>加入我们</strong></a>，从事产品工程和技术市场职位。</span>
  <br/>
  <br/>
  <div>
  </div>
...
<p align="center">
  ...
  <a href="https://www.ycombinator.com/companies/elasticdash">
  ...
  <a href="https://hub.docker.com/u/elasticdash" target="_blank">
    <img alt="Docker Pulls" src="https://img.shields.io/docker/pulls/elasticdash/elasticdash?labelColor=%20%23FDB062&logo=Docker&labelColor=%20%23528bff">
  </a>
  <a href="https://pypi.python.org/pypi/elasticdash">
    <img src="https://img.shields.io/pypi/dm/elasticdash?logo=python&logoColor=white&label=pypi%20elasticdash&color=blue" alt="elasticdash Python package on PyPi">
  </a>
  <a href="https://www.npmjs.com/package/elasticdash">
    <img src="https://img.shields.io/npm/dm/elasticdash?logo=npm&logoColor=white&label=npm%20elasticdash&color=blue" alt="elasticdash npm package">
  </a>
  <br/>
  ...
  <a href="https://github.com/elasticdash/elasticdash/graphs/commit-activity" target="_blank">
    <img alt="过去一个月的提交" src="https://img.shields.io/github/commit-activity/m/elasticdash/elasticdash?labelColor=%20%2332b583&color=%20%2312b76a">
  </a>
  <a href="https://github.com/elasticdash/elasticdash/" target="_blank">
    <img alt="已关闭的问题" src="https://img.shields.io/github/issues-search?query=repo%3Aelasticdash%2Felasticdash%20is%3Aclosed&label=issues%20closed&labelColor=%20%237d89b0&color=%20%235d6b98">
  </a>
  <a href="https://github.com/elasticdash/elasticdash/discussions/" target="_blank">
    <img alt="讨论帖数量" src="https://img.shields.io/github/discussions/elasticdash/elasticdash?labelColor=%20%239b8afb&color=%20%237a5af8">
  </a>
</p>
...
[![ElasticDash 概览视频](https://github.com/user-attachments/assets/3926b288-ff61-4b95-8aa1-45d041c70866)](https://elasticdash.com/watch-demo)

## ✨ 核心特性

![ElasticDash 概览](https://elasticdash.com/images/docs/github-readme/github-feature-overview.png)

- [LLM 应用可观察性](https://elasticdash.com/docs/tracing)：为你的应用插入仪表代码，并开始将追踪数据传送到 ElasticDash，从而追踪 LLM 调用及应用中其他相关逻辑（如检索、嵌入或代理操作）。检查并调试复杂日志及用户会话。试试互动的 [演示](https://elasticdash.com/docs/demo) 看看效果。
- [提示管理](https://elasticdash.com/docs/prompt-management/get-started) 帮助你集中管理、版本控制并协作迭代提示。得益于服务器和客户端的高效缓存，你可以在不增加延迟的情况下反复迭代提示。

- [评估](https://elasticdash.com/docs/evaluation/overview) 是 LLM 应用开发流程的关键组成部分，ElasticDash 能够满足你的多样需求。它支持 LLM 作为"裁判"、用户反馈收集、手动标注以及通过 API/SDK 实现自定义评估流程。

- [数据集](https://elasticdash.com/docs/evaluation/dataset-runs/datasets) 为评估你的 LLM 应用提供测试集和基准。它们支持持续改进、部署前测试、结构化实验、灵活评估，并能与 LangChain、LlamaIndex 等框架无缝整合。

- [LLM 试玩平台](https://elasticdash.com/docs/playground) 是用于测试和迭代提示及模型配置的工具，缩短反馈周期，加速开发。当你在追踪中发现异常结果时，可以直接跳转至试玩平台进行调整。

- [综合 API](https://elasticdash.com/docs/api)：ElasticDash 常用于驱动定制化的 LLMOps 工作流程，同时利用 ElasticDash 提供的构建模块和 API。我们提供 OpenAPI 规格、Postman 集合以及针对 Python 和 JS/TS 的类型化 SDK。

## 📦 部署 ElasticDash

![ElasticDash 部署选项](https://elasticdash.com/images/docs/github-readme/github-deployment-options.png)
...
<div align="center">
  <a href="https://cloud.elasticdash.com" target="_blank">
    <img alt="注册 ElasticDash Cloud" src="https://img.shields.io/badge/»%20Sign%20up%20for%20ElasticDash%20Cloud-8A2BE2?&color=orange">
  </a>
</div>
...
- [本地（docker compose）](https://elasticdash.com/self-hosting/local)：使用 Docker Compose 在你的机器上于 5 分钟内运行 ElasticDash。
...
- [Kubernetes（Helm）](https://elasticdash.com/self-hosting/kubernetes-helm)：使用 Helm 在 Kubernetes 集群上部署 ElasticDash。这是推荐的生产环境部署方式。

- [虚拟机](https://elasticdash.com/self-hosting/docker-compose)：使用 Docker Compose 在单台虚拟机上部署 ElasticDash。

- Terraform 模板: [AWS](https://elasticdash.com/self-hosting/aws)、[Azure](https://elasticdash.com/self-hosting/azure)、[GCP](https://elasticdash.com/self-hosting/gcp)

请参阅 [自托管文档](https://elasticdash.com/self-hosting) 了解更多关于架构和配置选项的信息。

## 🔌 集成

![ElasticDash 集成](https://elasticdash.com/images/docs/github-readme/github-integrations.png)

### 主要集成：

| 集成                                                                                    | 支持语言/平台          | 描述                                                                                                                 |
|-----------------------------------------------------------------------------------------|------------------------|----------------------------------------------------------------------------------------------------------------------|
| [SDK](https://elasticdash.com/docs/sdk)                                                 | Python, JS/TS          | 使用 SDK 进行手动仪表化，实现全面灵活性。                                                                              |
| [OpenAI](https://elasticdash.com/integrations/model-providers/openai-py)                | Python, JS/TS          | 通过直接替换 OpenAI SDK 实现自动仪表化。                                                                              |
| [Langchain](https://elasticdash.com/docs/integrations/langchain)                        | Python, JS/TS          | 通过传入回调处理器至 Langchain 应用实现自动仪表化。                                                                   |
| [LlamaIndex](https://elasticdash.com/docs/integrations/llama-index/get-started)         | Python                 | 通过 LlamaIndex 回调系统实现自动仪表化。                                                                              |
| [Haystack](https://elasticdash.com/docs/integrations/haystack)                          | Python                 | 通过 Haystack 内容追踪系统实现自动仪表化。                                                                            |
| [LiteLLM](https://elasticdash.com/docs/integrations/litellm)                            | Python, JS/TS (仅代理) | 允许使用任何 LLM 替代 GPT。支持 Azure、OpenAI、Cohere、Anthropic、Ollama、VLLM、Sagemaker、HuggingFace、Replicate（100+ LLMs）。 |
| [Vercel AI SDK](https://elasticdash.com/docs/integrations/vercel-ai-sdk)                | JS/TS                  | 基于 TypeScript 的工具包，帮助开发者使用 React、Next.js、Vue、Svelte 和 Node.js 构建 AI 驱动的应用。                      |
| [API](https://elasticdash.com/docs/api)                                                 |                        | 直接调用公共 API。提供 OpenAPI 规格。                                                                                  |
| [Google VertexAI 和 Gemini](https://elasticdash.com/docs/integrations/google-vertex-ai) | 模型                   | 在 Google 上运行基础模型和微调模型。                                                                                  |

### 与 ElasticDash 集成的软件包：

| 名称                                                                       | 类型          | 描述                                                                                 |
|----------------------------------------------------------------------------|---------------|--------------------------------------------------------------------------------------|
| [Instructor](https://elasticdash.com/docs/integrations/instructor)         | 库            | 用于获取结构化 LLM 输出（JSON、Pydantic）的库。                                          |
| [DSPy](https://elasticdash.com/docs/integrations/dspy)                     | 库            | 一个系统性优化语言模型提示和权重的框架。                                              |
| [Amazon Bedrock](https://elasticdash.com/docs/integrations/amazon-bedrock) | 模型          | 在 AWS 上运行基础模型和微调模型。                                                     |
| [Mirascope](https://elasticdash.com/docs/integrations/mirascope)           | 库            | 构建 LLM 应用的 Python 工具包。                                                       |
| [Ollama](https://elasticdash.com/docs/integrations/ollama)                 | 模型（本地）    | 在你的机器上轻松运行开源 LLM。                                                        |
| [AutoGen](https://elasticdash.com/docs/integrations/autogen)               | 代理框架      | 用于构建分布式代理的开源 LLM 平台。                                                   |
| [Flowise](https://elasticdash.com/docs/integrations/flowise)               | 聊天/代理界面 | 基于 JS/TS 的无代码构建器，用于定制化 LLM 流程。                                       |
| [Langflow](https://elasticdash.com/docs/integrations/langflow)             | 聊天/代理界面 | 基于 Python 的 LangChain 用户界面，采用 react-flow 设计，提供便捷的实验与原型构建体验。 |
| [Dify](https://elasticdash.com/docs/integrations/dify)                     | 聊天/代理界面 | 带有无代码构建器的开源 LLM 应用开发平台。                                             |
| [OpenWebUI](https://elasticdash.com/docs/integrations/openwebui)           | 聊天/代理界面 | 自托管的 LLM 聊天网页界面，支持包括自托管和本地模型在内的多种 LLM 运行器。             |
| [Promptfoo](https://elasticdash.com/docs/integrations/promptfoo)           | 工具          | 开源 LLM 测试平台。                                                                   |
| [LobeChat](https://elasticdash.com/docs/integrations/lobechat)             | 聊天/代理界面 | 开源聊天机器人平台。                                                                  |
| [Vapi](https://elasticdash.com/docs/integrations/vapi)                     | 平台          | 开源语音 AI 平台。                                                                    |
| [Inferable](https://elasticdash.com/docs/integrations/other/inferable)     | 代理          | 构建分布式代理的开源 LLM 平台。                                                       |
| [Gradio](https://elasticdash.com/docs/integrations/other/gradio)           | 聊天/代理界面 | 开源 Python 库，可用于构建类似聊天 UI 的网页界面。                                     |
| [Goose](https://elasticdash.com/docs/integrations/goose)                   | 代理          | 构建分布式代理的开源 LLM 平台。                                                       |
| [smolagents](https://elasticdash.com/docs/integrations/smolagents)         | 代理          | 开源 AI 代理框架。                                                                    |
| [CrewAI](https://elasticdash.com/docs/integrations/crewai)                 | 代理          | 多代理框架，用于实现代理之间的协作与工具调用。                                         |
...
1. [创建 ElasticDash 账户](https://cloud.elasticdash.com/auth/sign-up) 或 [自托管](https://elasticdash.com/self-hosting)
2. 创建一个新项目
3. 在项目设置中创建新的 API 凭证

### 2️⃣ 记录你的第一个 LLM 调用

使用 [<code>@observe()</code> 装饰器](https://elasticdash.com/docs/sdk/python/decorators) 可轻松跟踪任何 Python LLM 应用。在本快速入门中，我们还使用了 ElasticDash 的 [OpenAI 集成](https://elasticdash.com/integrations/model-providers/openai-py) 来自动捕获所有模型参数。

> [!提示]
> 不使用 OpenAI？请访问 [我们的文档](https://elasticdash.com/docs/get-started#log-your-first-llm-call-to-elasticdash) 了解如何记录其他模型和框架。
...
LANGFUSE_BASE_URL="https://cloud.elasticdash.com" # 🇪🇺 欧盟区域
# LANGFUSE_BASE_URL="https://us.cloud.elasticdash.com" # 🇺🇸 美洲区域
```
...
from elasticdash.openai import openai  # OpenAI 集成
...
![示例追踪记录](https://elasticdash.com/images/docs/github-readme/github-example-trace.png)

_[ElasticDash 中的公共示例追踪](https://cloud.elasticdash.com/project/cloramnkj0002jz088vzn1ja4/traces/2cec01e3-3dc2-472f-afcf-3b968cf0c1f4?timestamp=2025-02-10T14%3A27%3A30.275Z&observation=cb5ff844-07ef-41e6-b8e2-6c64344bc13b)_

> [!提示]
>
> [了解更多](https://elasticdash.com/docs/tracing) 关于 ElasticDash 中的追踪，或试试 [互动演示](https://elasticdash.com/docs/demo)。
...
- 我们的 [文档](https://elasticdash.com/docs) 是查找答案的最佳起点。内容全面，我们投入大量时间进行维护。你也可以通过 GitHub 提出文档修改建议。
- [ElasticDash 常见问题](https://elasticdash.com/faq) 解答了最常见的问题。
- 使用 "Ask AI" 立即获取问题答案。

支持渠道：

- **在 GitHub Discussions 的 [公共问答](https://github.com/orgs/elasticdash/discussions/categories/support) 中提出任何问题。** 请尽量提供详细信息（如代码片段、截图、背景信息）以帮助我们理解你的问题。
- 在 GitHub Discussions 中 [提出功能请求](https://github.com/orgs/elasticdash/discussions/categories/ideas)。
- 在 GitHub Issues 中 [报告 Bug](https://github.com/elasticdash/elasticdash/issues)。
...
- 在 GitHub Discussions 中为 [想法](https://github.com/orgs/elasticdash/discussions/categories/ideas)投票。
- 提出并评论 [问题](https://github.com/elasticdash/elasticdash/issues)。
- 提交 PR —— 详情请参见 [CONTRIBUTING.md](CONTRIBUTING.md)，了解如何搭建开发环境。

## 🥇 许可证

除 `ee` 文件夹外，本仓库采用 MIT 许可证。详情请参见 [LICENSE](LICENSE) 以及 [文档](https://elasticdash.com/docs/open-source)。
...
<a href="https://star-history.com/#elasticdash/elasticdash&Date">
  <picture>
    ...
    <img alt="星标历史图表" src="https://api.star-history.com/svg?repos=elasticdash/elasticdash&type=Date" style="border-radius: 15px;" />
  </picture>
</a>

## ❤️ 使用 ElasticDash 的开源项目

以下是使用 ElasticDash 的顶级开源 Python 项目，按星标数排名（[来源](https://github.com/elasticdash/elasticdash-docs/blob/main/components-mdx/dependents)）：
...
我们非常重视数据安全和隐私。更多信息请参阅我们的 [安全与隐私](https://elasticdash.com/security) 页面。

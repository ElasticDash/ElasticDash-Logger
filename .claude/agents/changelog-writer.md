...
1. Read 3-5 of the most recent changelog posts in `../elasticdash-docs/pages/changelog`
...
1. Check if there is relevant documentation in `../elasticdash-docs/pages` that relates to this feature
...
- The changelog lives in `../elasticdash-docs/pages/changelog`

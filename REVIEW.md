...
- When attempting to confirm if the current environment is ElasticDash Cloud in the frontend, use the `useElasticDashCloudRegion` hook and never environment variables directly.

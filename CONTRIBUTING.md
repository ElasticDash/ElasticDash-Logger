![ElasticDash GitHub Banner](https://github.com/elasticdash/elasticdash/assets/121163007/6035f0f3-d691-4963-b5d0-10cf506e9d42)
...
You can use the staging environment end-to-end with the ElasticDash integrations or SDKs (host: `https://staging.elasticdash.com`). However, please note that the staging environment is not intended for production use and may be reset at any time.
...
| --light-blue             | Light blue for background of Staging label                         | ElasticDashLogo                  |
| --dark-blue              | Dark blue for text and border of Staging label                     | ElasticDashLogo                  |

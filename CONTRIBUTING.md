![Langfuse GitHub Banner](https://github.com/elasticdash/elasticdash/assets/121163007/6035f0f3-d691-4963-b5d0-10cf506e9d42)
...
- Submit and vote on [Ideas](https://github.com/orgs/elasticdash/discussions/categories/ideas)
- Create and comment on [Issues](https://github.com/elasticdash/elasticdash/issues)
- Open a PR.
...
We gratefully welcome improvements to documentation ([docs repo](https://github.com/elasticdash/elasticdash-docs)), the core application (this repo) and the SDKs ([Python](https://github.com/elasticdash/elasticdash-python), [JS](https://github.com/elasticdash/elasticdash-js)).

The maintainers are available on [Discord](https://elasticdash.com/discord) in case you have any questions.
...
_Before making any significant changes, please [open an issue](https://github.com/elasticdash/elasticdash/issues)._ Discussing your proposed changes ahead of time will make the contribution process smooth for everyone. Changes that were not discussed in an issue may be rejected.

Once we've discussed your changes and you've got your code ready, make sure that tests are passing and open your pull request.

A good first step is to search for open [issues](https://github.com/elasticdash/elasticdash/issues). Issues are labeled, and some good issues to start with are labeled: [good first issue](https://github.com/elasticdash/elasticdash/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22).

## Project Overview

We recommend checking out DeepWiki to familiarize yourself with the project:

[![Ask DeepWiki](https://deepwiki.com/badge.svg)](https://deepwiki.com/elasticdash/elasticdash)
...
- JS SDK ([elasticdash/elasticdash-js](https://github.com/elasticdash/elasticdash-js))
  - openapi-typescript to generated types based on OpenAPI spec
- Python SDK ([elasticdash/elasticdash-python](https://github.com/elasticdash/elasticdash-python))
  - Pydantic for input validation, models generated by fern

### Architecture Overview

See this [diagram](https://elasticdash.com/self-hosting#architecture) for an overview of the architecture.
...
flowchart TB
    User["UI, API, SDKs"]
    subgraph vpc["VPC"]
        Web["Web Server<br/>(elasticdash/elasticdash)"]
        Worker["Async Worker<br/>(elasticdash/worker)"]
...
All tests run against a running elasticdash instance and **write/delete real data from the database**.
...
- **PostgreSQL**: Uses separate `elasticdash_test` database for isolation
...
We run a staging environment at [https://staging.elasticdash.com](https://staging.elasticdash.com) that is automatically deployed on every push to `main` branch.
...
You can use the staging environment end-to-end with the Langfuse integrations or SDKs (host: `https://staging.elasticdash.com`). However, please note that the staging environment is not intended for production use and may be reset at any time.
...
Langfuse is MIT licensed, except for `ee/` folder. See [LICENSE](LICENSE) and [docs](https://elasticdash.com/docs/open-source) for more details.

When contributing to the Langfuse codebase, you need to agree to the [Contributor License Agreement](https://cla-assistant.io/elasticdash/elasticdash). You only need to do this once and the CLA bot will remind you if you haven't signed it yet.

 ...
 * - generateDatasetTrace(): For dataset experiment runs (elasticdash-prompt-experiments env)
 * - generateEvaluationTraces(): For evaluation data (elasticdash-evaluation env)
...
export class DataGenerator {
  ...
  generateDatasetTrace(
    ...
    return createTrace({
      ...
      input: traceInput,
      output: traceOutput,
      environment: "elasticdash-prompt-experiments",
      metadata: { experimentType: "elasticdash-prompt-experiments" },
      public: false,
      bookmarked: false,
      session_id: null,
      tags: [],
          ...
          const observation: ObservationRecordInsertType = createObservation({
            ...
            provided_cost_details:
              obsType === "GENERATION"
                ...
                : undefined,
            environment: "elasticdash-evaluation",
          });

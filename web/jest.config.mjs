...
// jsonpath-plus is needed because @elasticdash/shared barrel exports evals/utilities which imports it
  ...
  projects: [
    {
      ...
      // Added transformIgnorePatterns to client tests to handle ESM dependencies from @elasticdash/shared
      // Without this, importing from @elasticdash/shared fails with "Unexpected token 'export'" errors

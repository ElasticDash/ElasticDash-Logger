...
import { type FilterState, type OrderByState } from "@elasticdash/shared";
...
export function DashboardWidget({
  ...
  dashboardOwner: "ELASTICDASH" | "PROJECT";
}) {
    ...
    >
      <div className="flex items-center justify-between">
        <span className="truncate font-medium" title={widget.data.name}>
          {widget.data.name}{" "}
          {dashboardOwner === "PROJECT" && widget.data.owner === "ELASTICDASH"
            ? " ( 🪢 )"
            : null}
        </span>

...
const EnvSchema = z.object({
  ...
  ELASTICDASH_S3_BATCH_EXPORT_ENDPOINT: z.string().optional(),
  ELASTICDASH_S3_BATCH_EXPORT_EXTERNAL_ENDPOINT: z.string().optional(),
  ELASTICDASH_S3_BATCH_EXPORT_ACCESS_KEY_ID: z.string().optional(),
  ELASTICDASH_S3_BATCH_EXPORT_SECRET_ACCESS_KEY: z.string().optional(),
  ELASTICDASH_S3_BATCH_EXPORT_FORCE_PATH_STYLE: z
    .enum(["true", "false"])
    .default("false"),
  ELASTICDASH_S3_BATCH_EXPORT_SSE: z.enum(["AES256", "aws:kms"]).optional(),
  ...
  ELASTICDASH_OTEL_INGESTION_QUEUE_PROCESSING_CONCURRENCY: z.coerce
    .number()
    .positive()
    .default(5),
  ELASTICDASH_INGESTION_QUEUE_PROCESSING_CONCURRENCY: z.coerce
    .number()
    .positive()
    .default(20),
  ELASTICDASH_INGESTION_SECONDARY_QUEUE_PROCESSING_CONCURRENCY: z.coerce
    .number()
    .positive()
    .default(5),
  ...
  ELASTICDASH_INGESTION_CLICKHOUSE_WRITE_BATCH_SIZE: z.coerce
    ...
    .positive()
    .default(1000),
  ELASTICDASH_INGESTION_CLICKHOUSE_WRITE_INTERVAL_MS: z.coerce
    .number()
    .positive()
    .default(1000),
  ELASTICDASH_INGESTION_CLICKHOUSE_MAX_ATTEMPTS: z.coerce
    .number()
    .positive()
    .default(3),
  ...
  ELASTICDASH_EVAL_CREATOR_LIMITER_DURATION: z.coerce
    .number()
    .positive()
    .default(500),
  ELASTICDASH_EVAL_CREATOR_WORKER_CONCURRENCY: z.coerce
    .number()
    .positive()
    .default(2),
  ELASTICDASH_TRACE_UPSERT_WORKER_CONCURRENCY: z.coerce
    .number()
    .positive()
    .default(25),
  ...
  ELASTICDASH_EVAL_EXECUTION_WORKER_CONCURRENCY: z.coerce
    ...
    .positive()
    .default(5),
  ELASTICDASH_EXPERIMENT_CREATOR_WORKER_CONCURRENCY: z.coerce
    .number()
    .positive()
    .default(5),
  ...
  ELASTICDASH_ENABLE_BACKGROUND_MIGRATIONS: z
    .enum(["true", "false"])
    .default("true"),

  ELASTICDASH_ENABLE_REDIS_SEEN_EVENT_CACHE: z
    .enum(["true", "false"])
    .default("false"),
  ...
  ELASTICDASH_BLOB_STORAGE_EXPORT_TRACE_ONLY_PROJECT_IDS: z
    .string()
    .optional()
  ...
  ELASTICDASH_EVENT_PROPAGATION_WORKER_GLOBAL_CONCURRENCY: z.coerce
    ...
    .positive()
    .default(10),
  ELASTICDASH_DATASET_RUN_BACKFILL_CHUNK_SIZE: z.coerce
    .number()
    .positive()
    .default(200),
  ELASTICDASH_EXPERIMENT_BACKFILL_THROTTLE_MS: z.coerce
    .number()
    .positive()
  ...
  ELASTICDASH_S3_CORE_DATA_EXPORT_IS_ENABLED: z
    .enum(["true", "false"])
    .default("false"),
  ELASTICDASH_S3_CORE_DATA_UPLOAD_BUCKET: z.string().optional(),
  ELASTICDASH_S3_CORE_DATA_UPLOAD_PREFIX: z.string().default(""),
  ELASTICDASH_S3_CORE_DATA_UPLOAD_REGION: z.string().optional(),
  ELASTICDASH_S3_CORE_DATA_UPLOAD_ENDPOINT: z.string().optional(),
  ELASTICDASH_S3_CORE_DATA_UPLOAD_ACCESS_KEY_ID: z.string().optional(),
  ELASTICDASH_S3_CORE_DATA_UPLOAD_SECRET_ACCESS_KEY: z.string().optional(),
  ELASTICDASH_S3_CORE_DATA_UPLOAD_FORCE_PATH_STYLE: z
    .enum(["true", "false"])
    .default("false"),
  ELASTICDASH_S3_CORE_DATA_UPLOAD_SSE: z.enum(["AES256", "aws:kms"]).optional(),
  ELASTICDASH_S3_CORE_DATA_UPLOAD_SSE_KMS_KEY_ID: z.string().optional(),
  ...
  ELASTICDASH_FREE_TIER_USAGE_THRESHOLD_ENFORCEMENT_ENABLED: z
    .enum(["true", "false"])
    .default("false"),

  ELASTICDASH_S3_CONCURRENT_READS: z.coerce.number().positive().default(50),
  ELASTICDASH_CLICKHOUSE_PROJECT_DELETION_CONCURRENCY_DURATION_MS: z.coerce
    .number()
    .positive()
    .default(600_000), // 10 minutes
  ELASTICDASH_CLICKHOUSE_TRACE_DELETION_CONCURRENCY_DURATION_MS: z.coerce
    .number()
    .positive()
    .default(120_000), // 2 minutes
  ELASTICDASH_CLICKHOUSE_DATASET_DELETION_CONCURRENCY_DURATION_MS: z.coerce
    .number()
    .positive()
    .default(120_000), // 2 minutes
  ...
  ELASTICDASH_DELETION_MUTATIONS_MAX_COUNT: z.coerce
    .number()
    .positive()
    .default(15),
  ELASTICDASH_DELETION_MUTATIONS_SAFE_COUNT: z.coerce
    .number()
    .positive()
    .default(1),

  // Batch Project Cleaner configuration
  ELASTICDASH_BATCH_PROJECT_CLEANER_ENABLED: z
    .enum(["true", "false"])
    .default("false"),
  ELASTICDASH_BATCH_PROJECT_CLEANER_SLEEP_ON_EMPTY_MS: z.coerce
    .number()
    .positive()
    .default(3_600_000), // 1hr
  ELASTICDASH_BATCH_PROJECT_CLEANER_PROJECT_LIMIT: z.coerce
    .number()
    .positive()
    .default(1000), // Max projects per batch
  ELASTICDASH_BATCH_PROJECT_CLEANER_DELETE_TIMEOUT_MS: z.coerce
    .number()
    .positive()
    .default(5_400_000), // 1.5 hours for DELETE operations

  ELASTICDASH_EXPERIMENT_BACKFILL_EXCLUDE_ATTRIBUTES_KEY: z
    .enum(["true", "false"])
    .default("false"),

  // Deprecated. Do not use!
  ELASTICDASH_EXPERIMENT_RETURN_NEW_RESULT: z
    .enum(["true", "false"])
    .default("false"),
  ELASTICDASH_EXPERIMENT_INSERT_INTO_EVENTS_TABLE: z
    .enum(["true", "false"])
    .default("false"),
  ELASTICDASH_EXPERIMENT_EARLY_EXIT_EVENT_BATCH_JOB: z
    .enum(["true", "false"])
    .default("false"),

  ELASTICDASH_WEBHOOK_QUEUE_PROCESSING_CONCURRENCY: z.coerce
    .number()
    .positive()
    .default(5),
  ELASTICDASH_WEBHOOK_TIMEOUT_MS: z.coerce.number().positive().default(10000),
  ELASTICDASH_WEBHOOK_MAX_REDIRECTS: z.coerce.number().positive().default(10),
  ELASTICDASH_ENTITY_CHANGE_QUEUE_PROCESSING_CONCURRENCY: z.coerce
    .number()
    .positive()
    .default(2),
  ELASTICDASH_DELETE_BATCH_SIZE: z.coerce.number().positive().default(2000),
  ELASTICDASH_TOKEN_COUNT_WORKER_POOL_SIZE: z.coerce
    .number()
    .positive()
    .default(2),
});
